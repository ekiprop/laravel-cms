...
class PostController extends Controller
{
    ...
    public function view($post_id){
        ...
        $likeCntr = Like::where(['post_id' => $likePost->id])->count();
        $dislikeCntr = Dislike::where(['post_id' => $likePost->id])->count();
        //return $likeCntr;
       // exit();
        $categories = Category::all();
        ...
        return view('posts.view', ['posts'=>$posts, 'categories'=>$categories, 'likeCntr'=>$likeCntr,
         'dislikeCntr'=>$dislikeCntr, 'comments'=>$comments]);
    ...
    public function comment(Request $request, $post_id){
        ...
        $comment->save();
        return redirect("/view/{$post_id}")->with('response','Post Commented Successfully');
