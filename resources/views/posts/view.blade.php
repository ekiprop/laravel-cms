                               ...
                               <ul class="nav nav-pills">
                                   <li role="presentation">
                                       <a href='{{ url("/like/{$post->id}") }}'>
                                           <span class="fas fa-thumbs-up"> Like({{$likeCntr}})</span>
                                       </a>
   
                                   </li>
                                   <li role="presentation">
                                           <a href='{{ url("/dislike/{$post->id}") }}'>
                                               <span class="far fa-thumbs-down"> Dislike({{$dislikeCntr}})</span>
                                           </a>
       
                                       </li>
                                       <li role="presentation">
                                               <a href='{{ url("/comment/{$post->id}") }}'>
                                                   <span class="far fa-thumbs-down"> COMMENT</span>
                                               </a>
