                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/addPost') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" rows="8"  class="form-control{{ $errors->has('post_body') ? ' is-invalid' : '' }}" name="post_body" value="{{ old('post_body') }}" required>
                                </textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="post_img" type="file" class="form-control{{ $errors->has('post_img') ? ' is-invalid' : '' }}" name="post_img" required>
